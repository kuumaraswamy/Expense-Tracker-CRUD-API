function saveToLocalStorage(event){
    ...
    event.preventDefault() 
      axios.post('https://crudcrud.com/api/cbc4acecd6894f939116aad2975099de/ExpenseTracker',obj)
         .then((response) => {
...
window.addEventListener("DOMContentLoaded", () => {
    axios.get('https://crudcrud.com/api/cbc4acecd6894f939116aad2975099de/ExpenseTracker')
        .then((response)=>{
...
function deleteList(listId){
    axios.delete(`https://crudcrud.com/api/cbc4acecd6894f939116aad2975099de/ExpenseTracker/${listId}`)
        .then((response)=>{
